...
/* Geçti / Kaldı yazdıran yardımcı makro */
...
void test_ref_sayisi() {
    ...
    liste_temizle(l2);
    TEST("l2 bosaltinca ref_sayisi == 0", s->ref_sayisi == 0);
